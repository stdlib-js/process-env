...
```javascript
import ENV from 'https://cdn.jsdelivr.net/gh/stdlib-js/process-env@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/process-env/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/process-env/actions/workflows/test.yml?query=branch:v0.1.1
